...
strategy = fl.server.strategy.FedAvg(
    ...
    min_fit_clients=NUM_OF_CLIENTS, # Minimum of 3 clients for training
    min_evaluate_clients=NUM_OF_CLIENTS, # Minimum of 3 clients for evaluation
    min_available_clients=NUM_OF_CLIENTS, # Minimum of 3 clients to start training
)
