...
# Ensure there are at least 50 clients
assert len(client_files) >= 50, "There must be at least 10 client files to select from."

# Select 5 random clients
selected_clients = random.sample(client_files, 10)
