...
plt.plot(df_filtered['round'], df_filtered['3_client_eval_loss'], marker='o', label='3 Client', markersize=15, linewidth=5, alpha=0.8)
plt.plot(df_filtered['round'], df_filtered['4_client_eval_loss'], marker='o', label='4 Client', markersize=15, linewidth=5, alpha=0.8)
