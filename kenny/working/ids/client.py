...
if __name__ == "__main__":
    ...
    if args.id == 3 and os.path.isfile(os.path.join(args.dataset, f'client_train_data_{args.id}p.csv')):
        df_train = pd.read_csv(os.path.join(args.dataset, f'client_train_data_{args.id}p.csv'))
    else:
