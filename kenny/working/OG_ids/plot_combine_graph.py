...
plot_metrics('eval_loss', 'Evaluation Loss', y_limits=(0.5, 1.6))
plot_metrics('eval_accuracy', 'Evaluation Accuracy', y_limits=(0.4, 0.72))
plot_metrics('f1_score', 'F1 Score', y_limits=(0.3, 0.68))
